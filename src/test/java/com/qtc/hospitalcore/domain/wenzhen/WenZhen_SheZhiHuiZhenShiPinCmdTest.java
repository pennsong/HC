...
public class WenZhen_SheZhiHuiZhenShiPinCmdTest {
        ...
        fixture.givenState(() -> {
            ...
            return record;
                ...
                .expectState(state -> {
                    ...
                    record.getHuiZhen().setShiPinLianJie("sp");
            ...
            // query model update
            WenZhen_SheZhiHuiZhenShiPinEvt evt = new WenZhen_SheZhiHuiZhenShiPinEvt(
                    id,
                    "sp"
            );
            ...
            record2.getHuiZhen().setShiPinLianJie("sp");
            // 修改record到预期结果 end
