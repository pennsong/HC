...
public class WenZhen_AnPaiHuiZhenCmdTest {
    ...
    public void test_WenZhen_AnPaiHuiZhenCmd() {
        ...
        // query model update
        WenZhen_AnPaiHuiZhenEvt evt = new WenZhen_AnPaiHuiZhenEvt(
                id,
                mockNow,
                "lj",
                "hy",
        ...
        record2.setHuiZhen(new HuiZhen(
                HuiZhenZhuangTai.YI_AN_PAI,
                mockNow,
                "lj",
                "hy",
    ...
    public void test_WenZhen_AnPaiHuiZhenCmd_失败_3() {
        ...
        fixture.givenState(() -> {
            ...
            return record;
                ...
                .expectException(PPBusinessException.class)
                .expectExceptionMessage("只有在没有完成会诊时才能安排会诊");
    }
}
